...
## DISCLAIMER:
PsyAI is =NOT= affiliated with Psychonautwiki.org or any of its current admins. It was co-crated by Josie Kins and myself (aka `sernyl` on Discord, `sernylan` on Telegram, `alevkov` on Github.
